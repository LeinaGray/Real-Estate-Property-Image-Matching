...
# AI IMAGES
ai_images = r"C:\Users\lenovo\OneDrive\Documents\PROJECTS\ALT\Real-Estate-Image-Matching\dataset\evaluation-dataset\AI"

# AUTHENTIC IMAGES
authentic_images = r"C:\Users\lenovo\OneDrive\Documents\PROJECTS\ALT\Real-Estate-Image-Matching\dataset\evaluation-dataset\authentic"

# COPYRIGHT IMAGES
# 1. No Exif Data
exif_images = r"C:\Users\lenovo\OneDrive\Documents\PROJECTS\ALT\Real-Estate-Image-Matching\dataset\evaluation-dataset\copyright\exif"
# 2.  Text Watermark Images
text_watermark_images = r"C:\Users\lenovo\OneDrive\Documents\PROJECTS\ALT\Real-Estate-Image-Matching\dataset\evaluation-dataset\copyright\watermark\text_watermark"
# 3. Transparent Logo Watermark Images
transparent_logo_watermark_images = r"C:\Users\lenovo\OneDrive\Documents\PROJECTS\ALT\Real-Estate-Image-Matching\dataset\evaluation-dataset\copyright\watermark\transparent_logo_watermark"
...
csv_data = []
def generate_fraud_dataset(list_of_image_paths, output_dir, filename):
    ...
    for count, path in enumerate(list_of_image_paths):
        ...
        target_dir = os.path.join(output_dir, csv_filename)
        ...
        metrics_filename = filename+"Metrics.csv"
        target_dir = os.path.join(output_dir, metrics_filename)
...
# text_watermark_image_paths = get_image_paths(text_watermark_images)
# transparent_logo_watermark_image_paths = get_image_paths(transparent_logo_watermark_images)
authentic_image_paths = get_image_paths(authentic_images)
# exif_image_paths = get_image_paths(exif_images)
# print(image_paths)
output_dir = r"evaluation\fraud-filter-system\test"
generate_fraud_dataset(authentic_image_paths, output_dir, "Authentic")
